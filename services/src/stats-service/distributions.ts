...
export function tTestPValue(t: number, df: number, tails: 1 | 2 = 2): number {
 ...
 */
const TUKEY_Q05: Record<number, number[]> = {
...
export function tukeyCriticalQ(k: number, df: number): number {
